            ...
            <div class="modal-content">
              ...
              <div class="modal-body" style="max-height: 75vh; overflow-y: auto;">
                <div class="terms-body">
                  <p class="text-center">(Last Updated on November 11th, 2024)</p>
                  <h4>The user agrees:</h4>
                  <ul>
                    <li>
                      to obtain required ethics, legal, or other approvals before using C-BIG and CAPTURE ALS Materials/Data.
                    </li>
                    <li>
                      to respect any restrictions and conditions on use of C-BIG and CAPTURE ALS Materials/Data based on: 
                      <ol>
                        <li>participant consents,</li>
                        <li>ethics approvals, and</li>
                        <li>the Open Transfer Agreement under which C-BIG and CAPTURE ALS Data/Materials were distributed.</li>
                      </ol>
                    </li>
                    <li>
                    ...
                    <li>
                      to ensure that Controlled Access Materials/Data are not distributed to anyone who does not have prior permission from the C-BIG Tissue and Data Committee and CAPTURE ALS Tissue
and Data Committee to have access to that Controlled Access Materials/Data, and to establish appropriate security safeguards. 
                    </li>
                    <li>
